...
--
-- Table structure for table `industries_menu_tbl`
--

CREATE TABLE `industries_menu_tbl` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `industries_menu_tbl`
--

INSERT INTO `industries_menu_tbl` (`id`, `title`, `slug`, `date`, `image`, `alt_tag`, `fb_url`, `tw_url`, `insta_url`, `description`, `status`) VALUES
...
--
-- Indexes for table `industries_menu_tbl`
--
ALTER TABLE `industries_menu_tbl`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `industries_menu_tbl`
--
ALTER TABLE `industries_menu_tbl`
