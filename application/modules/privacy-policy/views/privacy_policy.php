<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Privacy policy Configuration</li>
</ol>

<h1><span class="text-primary">Privacy policy Configuration</span></h1>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="privacy-policy Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/website-pages/privacy-policy-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
                    <!-- photo -->
