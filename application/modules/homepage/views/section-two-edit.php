...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Section Two</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Section Two" class="df-example demo-table">
            <form action="<?= site_url('admin/home-page/section-two-update/'.$model->id) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">

                    <div class="col-md-12 form-group">
                        <label for="photo">Photo <span class="text-danger">*</span></label>
                        <input type="file" data-default-file="<?= base_url() ?>uploads/home-page/<?= $model->photo ?>" name="photo" id="photo" class="font-control dropify">
                    </div>

                    <div class="col-md-4 form-group">
                        <label for="alt_tag">Alter Tag <span class="text-danger">*</span></label>
                        <input type="text" name="alt_tag" id="alt_tag" class="form-control" placeholder="Enter Plan Name" required value="<?= $model->alt_tag ?>">
                        <span class="text-danger"><?php printError('alt_tag') ?></span>
                    </div>
                    
                    <div class="col-md-4 form-group">
                        <label for="name">Name <span class="text-danger">*</span></label>
                        <input autocomplete="off" type="text" name="name" id="name" class="form-control" placeholder="Enter Name" required value="<?= $model->name ?>">
