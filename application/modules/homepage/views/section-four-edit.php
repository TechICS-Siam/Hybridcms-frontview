...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Section Four</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Section Four" class="df-example demo-table">
            <form action="<?= site_url('admin/home-page/section-four-update/'.$model->id) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
