<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Section Four Configuration</li>
</ol>

<div class="row">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Section Four</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/home-page/section-four-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Section Four Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/home-page/update-section-four') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('admin/home-page/section-four-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/home-page/section-four-delete/'.$model->id) ?>" class="delete-on-confirm">
