<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/home-page/section-seven') ?>">Section Seven</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Section Seven</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/home-page/section-seven') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Section Seven" class="df-example demo-table">
            <form action="<?= site_url('admin/home-page/section-seven-update/'.$model->id) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- tag -->
                    <div class="col-md-6 form-group">
                        <label for="tag">Tag <span class="text-danger">*</span></label>
                        <input value="<?=$model->tag ?>" type="text" name="tag" id="tag" class="form-control" placeholder="Enter tag" required>
                    </div>
