...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Section Ten</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Section Ten" class="df-example demo-table">
            <form action="<?= site_url('admin/home-page/section-ten/update/'.$model->id) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="alt_tag" id="alt_tag" class="form-control" placeholder="Enter Photo Alt Tag" autocomplete="off" value="<?= $model->alt_tag ?>">
                    </div>

                    <!-- title_one -->
                    <div class="col-md-6 form-group">
                        <label for="title_one">Title One <span class="text-danger">*</span></label>
                        <input type="text" name="title_one" id="title_one" class="form-control" placeholder="Enter Title One" autocomplete="off" value="<?= $model->title_one ?>">
                    </div>
                    
                    <!-- title_two -->
                    <div class="col-md-4 form-group">
                        <label for="title_two">Title Two <span class="text-danger">*</span></label>
                        <input type="text" name="title_two" id="title_two" class="form-control" placeholder="Enter Title Two" autocomplete="off" value="<?= $model->title_two ?>">
                    </div>
                    
                    <!-- percentages -->
                    <div class="col-md-4 form-group">
                        <label for="percentages">Percentages <span class="text-danger">*</span></label>
                        <input type="text" name="percentages" id="percentages" class="form-control" placeholder="Enter Percentages" autocomplete="off" value="<?= $model->percentages ?>">
                    </div>
