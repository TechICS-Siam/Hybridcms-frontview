<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Section Ten Configuration</li>
</ol>

<div class="row">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Section Ten</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/home-page/section-ten/create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Section Four Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/home-page/update-section-ten') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="button_text" id="button_text" class="form-control" value="<?= $row->button_text ?>">
                    </div>
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        <tr>
                            ...
                            <td><?= $model->title_one ?></td>
                            <td>
                                <span class="badge badge-<?= $model->status == 1 ? 'success' : 'warning'?>"><?= $model->status == 1 ? 'Active' : 'Inactive'?></span>
                            </td>
                            <td>
                                <a href="<?= site_url('admin/home-page/section-ten/edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/home-page/section-ten/delete/'.$model->id) ?>" class="delete-on-confirm">
