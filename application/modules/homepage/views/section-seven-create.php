...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Create New Section Seven</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Create a New Section Seven" class="df-example demo-table">
            <form action="<?= site_url('admin/home-page/section-seven-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="tag" id="tag" class="form-control" placeholder="Enter Tag" required>
                    </div>
