...
<div class="row">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Section Two</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/home-page/section-two-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="List of Price Plan" class="df-example demo-table">
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        <tr>
                            <td><?= $i ?></td>
                            <td><?= $model->name ?></td>
                            <td><img style="width:100px;" src="<?= base_url() ?>uploads/home-page/<?= $model->photo?>" alt="<?= $model->alt_tag?>" ></td>
                            <td>
                                <span class="badge badge-<?= $model->status == 1 ? 'success' : 'warning'?>"><?= $model->status == 1 ? 'Active' : 'Inactive'?></span>
                            </td>
                            <td>
                                <a href="<?= site_url('admin/home-page/section-two-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/home-page/section-two-delete/'.$model->id) ?>" class="delete-on-confirm">
