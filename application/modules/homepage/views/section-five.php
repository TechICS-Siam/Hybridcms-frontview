<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Section Five Configuration</li>
</ol>

<div class="row">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Section Five</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/home-page/section-five-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Section Five Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/home-page/update-section-five') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
                    <div class="col-md-12 form-group">
                        <label for="title">Title <span class="text-danger">*</span></label>
                        <input autocomplete="off" placeholder="Enter Title" type="text" class="form-control" name="title" id="title" value="<?= $model->title ?>">
                    </div>
                    <div class="col-md-12 form-group">
        ...
        <div data-label="List of Section Four" class="df-example demo-table">
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('admin/home-page/section-five-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/home-page/section-five-delete/'.$model->id) ?>" class="delete-on-confirm">
