<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/manage-services/manage-ressources') ?>">Manage Ressources</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Manage Ressources/span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/manage-services/manage-ressources') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Ressources" class="df-example demo-table">
     
            <form action="<?= site_url('admin/manage-services/manage-ressources-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- menu icon -->
