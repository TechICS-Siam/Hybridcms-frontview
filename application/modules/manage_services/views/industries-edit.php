<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/manage-services/manage-industries') ?>">Manage industries</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Manage industries/span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/manage-services/manage-industries') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Industries Services" class="df-example demo-table">
     
            <form action="<?= site_url('admin/manage-services/manage-industries-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                         <!-- menu icon -->
                         <div class="col-md-6 form-group">
                        <label for="menu_icon">Menu Icon</label>
                        <input type="text" name="menu_icon" id="menu_icon" class="form-control" value="<?= $model['menu_icon']?>" required>
                    </div>
                    <!-- menu name -->
                    <div class="col-md-6 form-group">
                        <label for="menu_name">Menu Name <span class="text-danger">*</span></label>
                        <input type="text" name="menu_name" id="menu_name" class="form-control" value="<?= $model['menu_name']?>" required>
                    </div>
                     <!-- menu link -->
                     <div class="col-md-6 form-group">
                        <label for="menu_link">Menu Link<span class="text-danger">*</span></label>
                        <input type="text" name="menu_link" id="menu_link" class="form-control" value="<?= $model['menu_link']?>" required>
                     </div>
                    <!-- menu title -->
                    <div class="col-md-6 form-group">
                        <label for="menu_title">Menu Title</label>
                        <input type="text" name="menu_title" id="menu_title" class="form-control" value="<?= $model['menu_title']?>" required>
                    </div>
