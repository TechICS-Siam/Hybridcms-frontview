<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/manage-services/manage-company') ?>">Manage company</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Create New Manage company</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/manage-services/manage-company') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Create a New Company Services" class="df-example demo-table">
            <form action="<?= site_url('admin/manage-services/manage-company-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- menu icon -->
                    <div class="col-md-6 form-group">
                        <label for="menu_icon">Service Name</label>
                        <input type="text" name="menu_icon" id="menu_icon" class="form-control" required>
                    </div>
                    <!-- menu name -->
                    <div class="col-md-6 form-group">
                        <label for="menu_name">Tag<span class="text-danger">*</span></label>
