...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Manage company/span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Company Services" class="df-example demo-table">
     
            <form action="<?= site_url('admin/manage-services/manage-company-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                     <!-- menu icon -->
