<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Manage Company Configuration</li>
</ol>
<!-- partner section one -->
<div class="row">
  <h1><span class="text-primary">Manage Company Services</span></h1>
</div>
<div class="row my-3">
    <div class="col-md-12 text-right">
        <a href="<?= site_url('admin/manage-services/manage-company-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Company Services Configuration" class="df-example demo-table" > 
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('admin/manage-services/manage-company-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/manage-services/manage-company-delete/'.$model->id) ?>" class="delete-on-confirm">
