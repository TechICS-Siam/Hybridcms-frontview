...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Partner Section Two</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/partner/partner-two-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
