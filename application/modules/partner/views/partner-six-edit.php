...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Partner Section Six</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/partner/partner-six-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                     ...
                     <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="main_title" id="main_title" class="form-control" value="<?= $model['main_title']?>" required>
                     </div>

                    <!-- Profile photo -->
                    <div class="col-md-12 form-group">
                        <label for="dp_image">Profile Image</label>
                        <input type="file" name="dp_image" id="dp_image" class="form-control dropify" data-default-file="<?= base_url() ?>uploads/sub_menu/<?= $model['dp_image'] ?>">
                    </div>
                    <!-- dp_name -->      
                    <div class="col-md-12 form-group">
                        <label for="dp_name">Name</label>
                        <input type="text" name="dp_name" id="dp_name" class="form-control" value="<?= $model['dp_name']?>" required>
                    </div>
                     <!-- button_text -->
                     <div class="col-md-6 form-group">
