<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/partner') ?>">Partner Section Three</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Partner Section Three</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/partner/partner-three-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- photo -->
                    ...
                    <div class="col-md-6 form-group">
                     ...
                     <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="address" id="address" class="form-control" value="<?= $model['address']?>" required>
                    </div>
                    <!-- description -->
                      <div class="col-md-12 form-group">
