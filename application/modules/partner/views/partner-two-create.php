<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/partner/partner') ?>">Partner Section Two</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Create Partner Section Two</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/partner/partner') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Create a New blog" class="df-example demo-table">
            <form action="<?= site_url('admin/partner/partner-two-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- photo -->
                   ...
                   <!-- title -->      
                    ...
                    <!-- description -->
                      <div class="col-md-12 form-group">
                        ...
                        <textarea name="description" id="description" class="form-control editor" placeholder="Enter Description" cols="30" rows="3"></textarea>
                    </div>
