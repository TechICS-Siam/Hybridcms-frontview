...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Create New Partner Section Three</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Create a New blog" class="df-example demo-table">
            <form action="<?= site_url('admin/partner/partner-three-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- photo -->
                   ...
                   <!-- dp_name -->      
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="dp_name" id="dp_name" class="form-control">
                    </div>
