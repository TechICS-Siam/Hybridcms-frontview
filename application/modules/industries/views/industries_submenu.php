<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Industries Menu Configuration</li>
</ol>

<div class="row">
  <h1><span class="text-primary">Industries Menu Configuration</span></h1>
    <div class="col-md-12">
        <?php
        ...
        <div data-label="Blog Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/industries/industries-submenu-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
