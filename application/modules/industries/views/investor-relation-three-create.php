...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Create a New blog" class="df-example demo-table">
            <form action="<?= site_url('admin/industries/investor-relation-three-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="tag_url" id="tag_url" class="form-control" required>
                     </div>
