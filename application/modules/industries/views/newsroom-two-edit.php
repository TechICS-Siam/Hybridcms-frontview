<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/industries/newsroom') ?>">Blog</a>
    </li>
...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/industries/newsroom') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/industries/newsroom-two-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="short_des_url" id="short_des_url" class="form-control" value="<?= $model['short_des_url'] ?>" required>
                     </div>
                    <!-- short description -->
