<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Newsroom Configuration</li>
</ol>
<!-- newsroom first -->
<div class="row">
  <h1><span class="text-primary">Newsroom Update Configuration</span></h1>
    <div class="col-md-12">
        <?php
        ...
        <?php } ?>
        <div data-label="Newsroom Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/industries/newsroom-top-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
...
<div class="row mt-3">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Newsroom Section One</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/industries/newsroom-one-create') ?>">
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        ...
                        <tr>                        
                            ...
                            <td>
                                <a href="<?= site_url('admin/industries/newsroom-one-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/industries/newsroom-one-delete/'.$model->id) ?>" class="delete-on-confirm">
...
<div class="row mt-3">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Newsroom Section Two</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/industries/newsroom-two-create') ?>">
            <button type="button" class="btn btn-xs btn-primary">Create &nbsp; <i data-feather="plus-square"></i></button>
        </a>
    </div>
</div>
                ...
                <table class="table table-bordered table-sm" id="content_management_table_t">
                    ...
                    <?php $i = 1; foreach($models_two as $model):  ?>
                        ...
                        <tr>                        
                            ...
                            <td>
                                <a href="<?= site_url('admin/industries/newsroom-two-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/industries/newsroom-two-delete/'.$model->id) ?>" class="delete-on-confirm">
                                    <button type="button" class="btn btn-outline-danger btn-xs btn-icon">
                                        <i data-feather="trash-2"></i>
                                    </button>
                                </a>
