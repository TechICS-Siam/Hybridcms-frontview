...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/industries/investor-relation-three-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <!-- tag url -->
                    <div class="col-md-6 form-group">
                        <label for="tag_url">Tag Url<span class="text-danger">*</span></label>
                        <input type="text" name="tag_url" id="tag_url" class="form-control" value="<?= $model['tag_url'] ?>" required>
                     </div>
