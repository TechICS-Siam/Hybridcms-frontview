<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/solutions/solution-sub') ?>">Blog</a>
    </li>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Create a New blog" class="df-example demo-table">
            <form action="<?= site_url('admin/solutions/solution-sub-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- tag -->
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="pckg_title" id="pckg_title" class="form-control"  required>
                    </div>
