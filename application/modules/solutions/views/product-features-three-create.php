<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/solutions/product-features') ?>">Blog</a>
    </li>
...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/solutions/product-features') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Create a New blog" class="df-example demo-table">
            <form action="<?= site_url('admin/solutions/product-features-three-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- photo -->
