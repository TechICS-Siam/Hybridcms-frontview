<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Solution Sub Configuration</li>
</ol>

<div class="row">
  <h1><span class="text-primary">Solution Sub Section One</span></h1>
    <div class="col-md-12">
        <?php
        ...
        <div data-label="Blog Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/solutions/solution-sub-one-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
...
<div class="row my-3">
    <div class="col-md-12 text-right">
        <a href="<?= site_url('admin/solutions/solution-sub-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
            <!-- <form action="<?= site_url('admin/solutions/solution-sub') ?>" method="post" enctype="multipart/form-data" id="user_form"> 
            </form> -->
        </div>
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        ...
                        <tr>                        
                            ...
                            <td>
                                <a href="<?= site_url('admin/solutions/solution-sub-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/solutions/solution-sub-delete/'.$model->id) ?>" class="delete-on-confirm">
