<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">webinars Configuration</li>
</ol>


<div class="row mt-3">
    <div class="col-md-8">
        <h1 class="mb-3"><span class="text-primary">Webinars</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/company/webinars-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="blog Configuration" class="df-example demo-table" >
            <!-- <form action="<?= site_url('admin/industries/webinars') ?>" method="post" enctype="multipart/form-data" id="user_form"> 
            </form> -->
        </div>
                ...
                <table class="table table-bordered table-sm" id="content_management_table">
                    ...
                    <?php $i = 1; foreach($models as $model):  ?>
                        ...
                        <tr>                        
                            ...
                            <td>
                                <a href="<?= site_url('admin/company/webinars-edit/'.$model->id) ?>">
                                    <button type="button" class="btn btn-outline-primary btn-xs btn-icon">
                                        <i data-feather="edit"></i>
                                    </button>
                                </a>
                                <a href="<?= site_url('admin/company/webinars-delete/'.$model->id) ?>" class="delete-on-confirm">
