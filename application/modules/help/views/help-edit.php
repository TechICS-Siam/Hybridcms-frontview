...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Help</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Help" class="df-example demo-table">
     
            <form action="<?= site_url('admin/website-pages/help-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- Menu -->
                    <div class="col-md-12 form-group">
                        <label for="menu">Menu<span class="text-danger">*</span></label>
                        <input type="text" name="menu" id="menu" class="form-control" value="<?= $model['menu']?>" required>
                    </div>

                    <!-- Submenu one -->
                      <div class="col-md-6 form-group">
                        <label for="quotes">Submenu One<span class="text-danger">*</span></label>
                        <input type="text" name="submenu_one" id="submenu_one" class="form-control" value="<?= $model['submenu_one']?>" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="submenu_one_link" id="submenu_one_link" class="form-control" value="<?= $model['submenu_one_link']?>" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="submenu_two" id="submenu_two" class="form-control" value="<?= $model['submenu_two']?>" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="submenu_two_link" id="submenu_two_link" class="form-control" value="<?= $model['submenu_two_link']?>" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="submenu_three" id="submenu_three" class="form-control" value="<?= $model['submenu_three']?>" required>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="submenu_three_link" id="submenu_three_link" class="form-control" value="<?= $model['submenu_three_link']?>" required>
                    </div>
                    <div class="col-md-12 form-group">
