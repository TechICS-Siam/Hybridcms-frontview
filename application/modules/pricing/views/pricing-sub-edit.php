<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/pricing/pricing-sub') ?>">Pricing Sub</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Pricing Sub</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/pricing/pricing-sub') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update Pricing Sub" class="df-example demo-table">
            <form action="<?= site_url('admin/pricing/pricing-sub-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input value="<?= $model['button_text'] ?>" type="text" name="button_text"  id="button_text" class="form-control" required placeholder="Enter Button Text">
                    </div>

                    <div class="col-md-4 form-group">
                        <label for="button_url">Button URL <span class="text-danger">*</span></label>
                        <input value="<?= $model['button_url'] ?>" type="text" name="button_url" id="button_url" class="form-control" required placeholder="Enter Button URL"> 
                    </div>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select name="button_open" id="button_open" class="form-control select">
                            ...
                            <option <?= $model['button_open'] == 0 ? 'selected' : '' ?> value="0">No</option>
                        </select>
                    </div>

                    <div class="col-md-6 form-group">
                        <label for="feature_title">Feature Title <span class="text-danger">*</span></label>
                        <input value="<?= $model['feature_title'] ?>" type="text" name="feature_title" id="feature_title" class="form-control" placeholder="Enter Feature Title" required>
                    </div>
                    ...
                    <div class="col-md-12 mt-4 form-group">
                        ...
                        ?>
                                <div class="row mt-2">
                                    <div class="col-md-10">
                                        <input type="text" name="features[]" placeholder="Enter Product Feature" class="form-control" value="<?= $feature?>"/>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="javascript:void(0);" class="remove_button">
                                            <button type="button" class="btn btn-outline-danger btn-block btn-icon">
