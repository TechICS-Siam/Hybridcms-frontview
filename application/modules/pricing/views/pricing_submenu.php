<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Pricing Menu Configuration</li>
</ol>

<div class="row">
  <h1><span class="text-primary">Pricing Menu Configuration</span></h1>
    <div class="col-md-12">
        <?php
        ...
        <div data-label="Blog Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/pricing/pricing-submenu-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
