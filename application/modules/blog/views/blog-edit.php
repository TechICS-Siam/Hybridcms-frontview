<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/website-pages/blog') ?>">Blog</a>
    </li>
...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/website-pages/blog') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div data-label="Update blog" class="df-example demo-table">
            ...
            <form action="<?= site_url('admin/website-pages/blog-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" name="fb_url" id="fb_url" class="form-control" value="<?= $model['fb_url']?>" required>
                    </div>

                    <!-- tw_url -->
                    <div class="col-md-4 form-group">
                        <label for="menu">Twitter Link<span class="text-danger">*</span></label>
                        <input type="text" name="tw_url" id="tw_url" class="form-control" value="<?= $model['tw_url']?>" required>
                    </div>

                    <!-- insta_url -->
                    <div class="col-md-4 form-group">
                        <label for="menu">Instagram Link<span class="text-danger">*</span></label>
                        <input type="text" name="insta_url" id="insta_url" class="form-control" value="<?= $model['insta_url']?>" required>
                    </div>
