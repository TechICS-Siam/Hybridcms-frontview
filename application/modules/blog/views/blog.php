  ...
  <h1><span class="text-primary">Blog Info Configuration</span></h1>
    <div class="col-md-12">
        ...
        <div data-label="Blog Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/website-pages/blog-info-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
...
<div class="row mt-3">
    ...
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/website-pages/blog-create') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="blog Configuration" class="df-example demo-table" >
            <!-- <form action="<?= site_url('admin/website-pages/blog') ?>" method="post" enctype="multipart/form-data" id="user_form"> 
            </form> -->
        </div>
