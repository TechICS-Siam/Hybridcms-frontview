...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Create New Faq</span></h1>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Create a New faq" class="df-example demo-table">
            <form action="<?= site_url('admin/website-pages/faq-store') ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                   ...
                   <div class="col-md-12 form-group">
                        ...
                        <textarea name="submenu" id="submenu" class="form-control editor" placeholder="Enter Description" cols="30" rows="3"></textarea>
                    </div>
