<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item">
        <a href="<?= site_url('admin/website-pages/faq') ?>">Faq</a>
    </li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><span class="text-primary">Update Faq</span></h1>
    </div>
    <div class="col-md-4 text-right">
        <a href="<?= site_url('admin/website-pages/faq') ?>">
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Update faq" class="df-example demo-table">
     
            <form action="<?= site_url('admin/website-pages/faq-update/'.$model['id']) ?>" method="post" id="user_form" enctype="multipart/form-data">
                <div class="row">
                    <!-- Title -->
                    ...
                    <!-- Description -->
                      <div class="col-md-12 form-group">
                        <label for="quotes">Description<span class="text-danger">*</span></label>
                        <textarea name="submenu" id="submenu" class="form-control editor" placeholder="Enter Description" cols="30" rows="3"><?= $model['submenu'] ?></textarea>
                    </div>
