<ol class="breadcrumb df-breadcrumbs mg-b-10">
    ...
    <li class="breadcrumb-item active" aria-current="page">Terms Configuration</li>
</ol>

<h1><span class="text-primary">Terms Configuration</span></h1>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <div data-label="Terms Configuration" class="df-example demo-table" >
            <form action="<?= site_url('admin/website-pages/terms-update') ?>" method="post" enctype="multipart/form-data" id="user_form">
                <div class="row">
